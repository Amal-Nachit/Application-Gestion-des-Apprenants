...
<div class="flex md:w-1/2 justify-center py-10 items-center bg-white">
	<div>
		<h1 class="text-gray-800 md-flex items-center font-bold text-2xl mb-5">Bienvenue</h1>
			<div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
				...
				<input class="pl-2 outline-none border-none Email" type="text" name="Email" id="" placeholder="Adresse mail" />
      		</div>
